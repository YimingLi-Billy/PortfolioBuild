  ...
  try {
    ...
    if (about) {
      ...
      if (about.avatar) {
        ...
        console.log("CONTROLLER: CLOUDINARY DESTROY SUCCESS, BEFORE UPLOAD");
        const myCloud = await cloudinary.v2.uploader.upload(about.avatar, {
          folder: "portfolio",
        });
        console.log("CONTROLLER: UPLOAD SUCCESS");
    ...
    console.log("IN USERUPDATE CATCH, MESSAGE: ", error.message);
    return res.status(400).json({
      success: false,
      message: error.message,
    });
